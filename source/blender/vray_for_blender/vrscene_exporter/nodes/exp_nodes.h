...
public:
	...
	// TODO: static BL::NodeSocket   getSocketByAttr(BL::Node node, const std::string &socketName);
	...
	static std::string      exportLinkedSocket(BL::NodeTree ntree, BL::NodeSocket socket);
