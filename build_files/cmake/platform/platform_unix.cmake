...
if(WITH_OPENCOLLADA)
	...
	if(OPENCOLLADA_FOUND)
		...
		if (NOT PCRE_ROOT_DIR AND NOT $ENV{PCRE_ROOT_DIR} STREQUAL "")
			message(STATUS "PCRE: find_package_wrapper(PCRE)")
			find_package_wrapper(PCRE)
		else()
			SET(PCRE_LIBRARIES ${PCRE_ROOT_DIR}/lib/libpcre.a)
			SET(PCRE_INCLUDE_DIRS ${PCRE_ROOT_DIR}/include)
			message(STATUS "PCRE: LIB ${PCRE_LIBRARIES} INCLUDE ${PCRE_INCLUDE_DIRS}")
		endif()
	else()
