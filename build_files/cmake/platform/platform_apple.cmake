...
if (DEFINED PREBUILT_ZLIB AND EXISTS "${PREBUILT_ZLIB}/")
	message(STATUS "Using prebuilt zlib from [${PREBUILT_ZLIB}]")
	set(ZLIB "${PREBUILT_ZLIB}")
	set(ZLIB_INCLUDE_DIRS "${ZLIB}/include")
	set(ZLIB_LIBRARIES "${ZLIB}/lib/libz.a" bz2)
else()
	message(STATUS "Using system zlib from /usr")
	set(ZLIB /usr)
	set(ZLIB_INCLUDE_DIRS "${ZLIB}/include")
